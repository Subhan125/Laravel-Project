												...
												<div class="item">
													<div class="product-box">
														<div class="product-img">
															@if( $relatedProduct->book_img == 'No image found')
															<img src="/assets/images/no-img.png" width="" height="200" alt="No image found">
															@else
															<img src="/uploads/{{ $relatedProduct->book_img }}" width="" height="200"  alt="{{  $relatedProduct->title }}">
															@endif
														</div>
														<div class="product-detail">
															<span>{{ Str::limit($relatedProduct->title, 20, '...') }}</span>
															<h5>{{ $relatedProduct->title }}</h5>
															<p>{{ Str::limit($relatedProduct->description, 60, '...') }}</p>
															<div class="rating-nd-price">
																<strong>Rs/ {{ number_format($relatedProduct->price) }}</strong>
