...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
        <a id="activeAllStatus" url="{{ route('team.statusActive') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye"></i></a>
            <a id="deactiveAllStatus" url="{{ route('team.statusDeactive') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye-slash"></i></a>
                    <a id="deleteAll" url="{{ route('team.deleteAll') }}" class="btn btn-danger btn-xm"><i class="fa fa-trash"></i></a>
    ...
    <div class="box-body">
        ...
        <table class="table table-bordered">
            ...
            <img src="/assets/admin/dist/img/no-img.png" width="100" height="100" class="img-thumbnail" alt="{{ $team->title }}">
            @else
                ...
                <td>
                    ...
                    @method('delete')
                      <a href="/admin/team/{{ $team->id }}/edit" class="btn btn-info btn-flat btn-sm"> <i class="fa fa-edit"></i></a>
                       <button class="btn btn-danger btn-flat btn-sm singleDelete" onclick="return confirm('Are you sure you want to delete this?')"> <i class="fa fa-trash-o"></i></button>
                     </form>
                </td>
            </tr>
            @endforeach
    ...
    @else
    <div class="alert alert-dander">No recound found</div>
    @endif
</div>
<!-- /.box-body -->
</div>
