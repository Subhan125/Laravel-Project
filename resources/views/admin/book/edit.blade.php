                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="country_of_publisher" id="country_of_publisher" style="width: 100%;">
                      ...
                      @foreach($countries as $country)
                        <option value="{{ $country->name }}" {{ ($book->country == $country->name) ? 'selected' : null }}>{{ $country->name }}</option>
                        @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="description" rows="5" id="description" placeholder="Enter...">{{ $book->description }}</textarea>
                    </div>
                </div>
            </div>
