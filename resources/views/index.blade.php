						...
						<div class="release-book-slider">
							...
							<div class="item">
								<div class="detail">
									...
									<span>Rs/ {{ number_format($upcoming_book->price) }}</sup></span>
			    				...
			    				<div class="product-box">
			    					<div class="product-img">
			    						...
			    						<ul class="product-cart-option position-center-x">
			    							<li><a href="{{ $downloaded_book->facaebook_id }}" target="_blank"><i class="fa fa-facebook"></i></a></li>
			    					...
			    					<div class="product-detail">
			    						...
			    						<div class="aurthor-detail">
			    							<span><img src="/assets/images/book-aurthor/img-01.jpg" alt="">{{ $downloaded_book->author_title }}</span>
			    						</div>
			    					</div>
			    				</div>
			    			</div>
			...
			<div class="container">
				...
				<div class="recomend-slider">
					...
					<div class="item">
						...
						<a href="#"><img src="/assets/images/no-img.png" width="109" height="150" alt="No image found"></a>
						@else
						<a href=""><img src="/uploads/{{ $recomended_book->book_img }}"></a>
						@endif
					</div>
					<!-- Item -->
					@empty
					<div class="alert alert-danger">No record image</div>
					@endforelse
						...
						<div id="timeline">
							<ul id="issues">
								<li id="1985">
									<div class="text-box">
										<div class="left-box">
											<h5><span class="theme-color">{{ $author_feature->title }}</span> {{ $author_feature->desination }}</h5>
